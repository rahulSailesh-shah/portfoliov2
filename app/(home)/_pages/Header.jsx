    ...
    <main className="bg-[#111111] w-full h-screen ml-32">
      ...
      <div className="flex flex-col justify-center h-full ml-8 ">
        <div className="w-1/2 pr-12">
          <h1 className="mb-4">
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">R</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">A</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">H</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">U</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-6">L</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">S</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">H</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">A</span>
            <span className="text-2xl font-medium text-[#cdcdcd] mr-2">H</span>
          </h1>
